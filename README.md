...
- 日文の短編ストーリーと四つの記憶ログ
- 山 → 月 → 星の順になぞる絵画パズル
- 密文「ク・カ・ケ」を「キ・オ・ク」へ戻す日記の文字置換パズル
- 四枚の葉を朝 → 昼 → 夕 → 夜へ向ける植木鉢の空間パズル
- 絵と日記の手がかりを組み合わせる時計パズル
- 第一の部屋で得た四つの紋章を組み合わせる地下観測室
- CSS で描画した整理済みの一部屋
...
# デスクトップ寸法でも同じ流程を実行
VIEWPORT_WIDTH=1280 VIEWPORT_HEIGHT=720 node tests/mobile-smoke.mjs
```

開始、音声切替、四つの謎の誤答と正解、四つの調査、リセット、
開扉、エンディング、水平オーバーフローを検証します。
